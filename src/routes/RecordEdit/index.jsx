...
function RecordEdit() {
  ...
  const handleEdit=(values)=>{
    ...
    dispatch(getrecord(date_recorded, distance, duration, id, user, user_fullname));
  }
      ...
      <Row>
        ...
        <Col md = {{span:4, offset:4}}>
          <Form onSubmit={handleSubmit(handleEdit)}>
            ...
            {
              errors.date ?
              <p role="alert" style={{ color: 'red' }}>{errors.date.message}</p> : undefined
            }
            <Row>
              <Col>
                <Form.Group>
                ...
                {
                  errors.durationHour ?
                  <p role="alert" style={{ color: 'red' }}>{errors.durationHour.message}</p> : undefined
                }              
              </Col>
              ...
              <Col style={{marginTop: '2em'}}>
                ...
                {
                  errors.durationMin ?
                  <p role="alert" style={{ color: 'red' }}>{errors.durationMin.message}</p> : undefined
                }              
              </Col>
              ...
              <Col style={{marginTop: '2em'}}>
                ...
                {
                  errors.durationSec ?
                  <p role="alert" style={{ color: 'red' }}>{errors.durationSec.message}</p> : undefined
                }              
              </Col>
            </Row>
            ...
            <InputGroup className="mb-3">
              ...
              {
                  errors.distance ?
                  <p role="alert" style={{ color: 'red' }}>{errors.distance.message}</p> : undefined
                }   
              ...
              <Form.Control
                  ...
                  />
                {
                  errors.user_fullname ?
                    <p role="alert" style={{ color: 'red' }}>{errors.user_fullname.message}</p> : undefined
